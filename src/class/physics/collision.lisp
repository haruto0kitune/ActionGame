...
(defun collide (instance1 instance2)
  ...
  (let* ((c-x1 (x (collision instance1)))
	 (c-y1 (y (collision instance1)))
	 (c-w1 (w (collision instance1)))
	 (c-h1 (h (collision instance1)))
	 (c-hw1 (/ c-w1 2))
	 (c-hh1 (/ c-h1 2))
	 (c-cpx1 (+ c-x1 c-hw1))
	 (c-cpy1 (+ c-y1 c-hh1))
	 (c-x2 (x (collision instance2)))
	 (c-y2 (y (collision instance2)))
	 (c-w2 (w (collision instance2)))
	 (c-h2 (h (collision instance2)))
	 (c-hw2 (/ c-w2 2))
	 (c-hh2 (/ c-h2 2))
	 (c-cpx2 (+ c-x2 c-hw2))
	 (c-cpy2 (+ c-y2 c-hh2))
	 ...
	 (x1 (x (image instance1))
	 (y1 (y (image instance1)))
	 (w1 (w (image instance1)))
	 (h1 (h (image instance1)))
	 (hw1 (/ w1 2))
	 (hh1 (/ h1 2))
	 (cpx1 (+ x1 hw1))
	 (cpy1 (+ y1 hh1))
	 (x2 (x (image instance2)))
	 (y2 (y (image instance2)))
	 (w2 (w (image instance2)))
	 (h2 (h (image instance2)))
	 (hw2 (/ w2 2))
	 (hh2 (/ h2 2))
	 (cpx2 (+ x2 hw2))
	 (cpy2 (+ y2 hh2))
    ...
    (when (and (<= c-top1 c-bottom2)
      ...
      (funcall (var-jump instance1) t)
      (setf (jump-flag instance1) nil)
      (setf (y (collision instance1)) c-bottom2)
      (setf (y (image instance1)) (- c-bottom2 (cy-minus-py instance1))))
    ;; bottom1 and top2
    (when (and (>= c-bottom1 c-top2)
      ...
      (setf (y (collision instance1)) (- (- c-top2 c-hh1) c-hh1))
      (setf (y (image instance1))
	    (- (- (- c-top2 c-hh1) c-hh1) (cy-minus-py instance1))))
    ;;left1 and right2
;    (if (eq top1-and-bottom2 t)
	...
	(setf (left-collision-flag instance1) t)
	(setf (x (collision instance1)) right2)
	(setf (x (image instance1)) (- right2 (cx-minus-px instance1)))))
...
;	(if (eq top1-and-bottom2 t)
    (when (and (> c-right1 c-left2)
      ...
      (setf collision-flag t)
      (when (not (eq top1-and-bottom2 t))
	(setf (right-collision-flag instance1) t)
	(setf (x (collision instance1)) (- (- c-left2 c-hw1) c-hw1))
	(setf (x (image instance1)) (- (- (- c-left2 c-hw1) c-hw1)
			       (cx-minus-px instance1)))))
